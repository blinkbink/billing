...
public interface ContextConstants extends Constants {
    ...
    public static final String SYN ="synch"; 

    public static final String MAINMENU ="mainmenuSL"; 

    public static final String SUBMENU ="submenuSL"; 
    
    public static final String TITLE ="DigitalSignature"; 
